...
<Callout type='warn'>
    **Regionized Chunk Ticking** is new and may cause compatibility issues with certain plugins. In
    case of incompatibility, report the issue to the plugin developer. It may also have it's fair share
    of bugs that need to be worked out, if you encounter anything, please report it ASAP!
</Callout>
