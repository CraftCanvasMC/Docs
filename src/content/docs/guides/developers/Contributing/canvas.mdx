...
plugins use NMS with Canvas, or for forks of Canvas. This system adds "base" patches, which are essentially feature patches applied before all Canvas patches.
