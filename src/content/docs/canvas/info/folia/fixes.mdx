...
The end credits were disabled by Folia due to Folia's rewrite of respawning logic. Folia's respawning logic contains the method:
...
- [EntityTeleportAsyncEvent](https://maven.canvasmc.io/javadoc/snapshots/io/canvasmc/canvas/canvas-api/1.21.11-R0.1-SNAPSHOT/raw/io/canvasmc/canvas/event/EntityTeleportAsyncEvent.html) is added
- [EntityPostTeleportAsyncEvent](https://maven.canvasmc.io/javadoc/snapshots/io/canvasmc/canvas/canvas-api/1.21.11-R0.1-SNAPSHOT/raw/io/canvasmc/canvas/event/EntityPostTeleportAsyncEvent.html) is added
- [EntityPostPortalAsyncEvent](https://maven.canvasmc.io/javadoc/snapshots/io/canvasmc/canvas/canvas-api/1.21.11-R0.1-SNAPSHOT/raw/io/canvasmc/canvas/event/EntityPostPortalAsyncEvent.html) is added
- [EntityPortalAsyncEvent](https://maven.canvasmc.io/javadoc/snapshots/io/canvasmc/canvas/canvas-api/1.21.11-R0.1-SNAPSHOT/raw/io/canvasmc/canvas/event/EntityPortalAsyncEvent.html) is added
- [PlayerViewEndCreditsEvent](https://maven.canvasmc.io/javadoc/snapshots/io/canvasmc/canvas/canvas-api/1.21.11-R0.1-SNAPSHOT/raw/io/canvasmc/canvas/event/PlayerViewEndCreditsEvent.html) is added
...
This was already attempted by another person, <u>**masmc05**</u> in PR [63](https://github.com/PaperMC/Folia/pull/63) in Folia's repository.
...
This section is outdated and subject for relocation/update
...
and replace it with adding tickets within a 1024 block radius of 0,0, mimicking Folia's startup changes. We also add the world to the `RegionizedServer`
